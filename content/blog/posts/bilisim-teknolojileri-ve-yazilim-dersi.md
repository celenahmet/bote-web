...
faq:
  - q: "Bilişim Teknolojileri ve Yazılım dersi zorunlu mu?"
    a: "Ortaokulda 5. ve 6. sınıflarda zorunlu, 7. ve 8. sınıflarda seçmelidir. Haftalık ders saatleri MEB'in haftalık ders çizelgesiyle belirlenir; güncel çizelgeyi kontrol edin."
  - q: "BTY dersi haftada kaç saat?"
    a: "5. ve 6. sınıflarda zorunlu ders olarak haftada 2 saattir. Çizelgeler zaman zaman güncellendiği için okulunuzun uyguladığı güncel haftalık ders çizelgesine bakın."
  - q: "Bilişim dersine hangi öğretmen girer?"
    a: "Hangi alandaki öğretmenin hangi dersi okutacağı MEB'in Öğretmenlik Alanları, Atama ve Ders Okutma Esasları'ndaki çizelgelerle belirlenir. 2025'ten itibaren genel okullar için Bilgisayar ve Öğretim Teknolojileri, mesleki ve teknik eğitim kurumları için Bilişim Teknolojileri alanı bulunuyor."
  - q: "BTY dersinde neler öğretilir?"
    a: "Program ünite temellidir. Bilişim teknolojilerinin güvenli ve etik kullanımı, iletişim ve iş birliği, ürün oluşturma ile problem çözme ve programlama programın başlıca konularıdır."
  - q: "Kodlama dersi ile BTY aynı şey mi?"
    a: "Günlük dilde BTY dersi sıkça kodlama dersi olarak anılır. Oysa programlama dersin önemli bir parçası olsa da tamamı değildir; güvenli teknoloji kullanımı ve dijital ürün oluşturma da dersin kapsamındadır."
  - q: "Avrupa'da okullarda bilişim dersi var mı?"
    a: "Evet. Eurydice'nin 2022 raporu, bilişimin bazı ülkelerde ayrı bir ders olarak, bazılarında diğer derslere entegre biçimde öğretildiğini ve sistemlerin üçte ikisinden fazlasının programlarını güncellediğini gösteriyor."
sources:
  - id: bty-program
...
MEB'in öğretim programı BTY'yi ortaokul ve imam hatip ortaokulu 5. ve 6. sınıflar için tanımlar.[@bty-program] Ders bu iki sınıf düzeyinde zorunlu olarak haftada iki saat okutulur; 7. ve 8. sınıflarda ise seçmeli ders olarak yer alır. Haftalık ders saatlerinin güncel dağılımı MEB'in haftalık ders çizelgesinde yayımlanır.[@ttkb-cizelge]

## Program neyi amaçlıyor?

Öğretim programı ünite temelli bir yapıya sahiptir. Öğrencilerin bilişim teknolojilerini güvenli ve etik biçimde kullanması, iletişim ve iş birliği araçlarından yararlanması, dijital ürün oluşturması ve **problem çözme ve programlama** becerisi kazanması hedeflenir.[@bty-program]
...
BTY, ezbere dayalı bir ders olarak tasarlanmamıştır. Program öğrencinin **ürün ortaya koymasını** önemser: bir sunum, basit bir animasyon, bir oyun ya da bir problemi çözen kısa bir program.[@bty-program] Bu nedenle ders çoğunlukla proje temelli ilerler. Tipik bir ünite şöyle akabilir:
