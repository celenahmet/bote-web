...
faq:
  - q: "Millî Eğitim Akademisi nedir?"
    a: "7528 sayılı Öğretmenlik Mesleği Kanunu ile öğretmenliğe giriş sürecine eklenen hazırlık eğitimini veren yapıdır. MEB'e öğretmen olarak atanabilmek için akademinin hazırlık eğitimini başarıyla tamamlamak gerekir."
  - q: "Hazırlık eğitimi kaç dönem?"
    a: "MEB'in yayımladığı programa göre hazırlık eğitimi onar haftalık dört dönemden oluşur. Akademik Kurul kararıyla belirlenen bazı yükseköğretim programları için üç dönem olarak uygulanabilir."
  - q: "Hazırlık eğitiminde neler var?"
    a: "İlk üç dönem ortak derslerden, dördüncü dönem ise tamamen uygulamadan oluşur. Ayrıntılı ders programı MEB tarafından yayımlanır."
  - q: "Akademiye nasıl girilir?"
    a: "Akademiye kabul, ÖSYM'nin yaptığı Millî Eğitim Bakanlığı Akademi Giriş Sınavı (AGS) sonuçlarına göre yapılır. Başvuru koşulları her dönem ilanla duyurulur."
  - q: "İlk hazırlık eğitimi ne zaman başladı?"
    a: "İlk hazırlık eğitimi 13 Nisan 2026'da başladı. Açıklanan akademik takvime göre dördüncü dönem 7 Aralık'ta başlayacak ve eğitim 22 Şubat 2027'de tamamlanacak."
  - q: "Hazırlık eğitimi için pedagojik formasyon gerekir mi?"
    a: "Aralık 2025'te öğretmenlik esaslarında yapılan değişiklikle, akademi hazırlık eğitimine alınacak adaylarda pedagojik formasyonla ilgili şartlar aranmıyor. Kaynak program koşulları için güncel esasları kontrol edin."
sources:
  - id: rg7528
...
18 Ekim 2024'te Resmî Gazete'de yayımlanan 7528 sayılı Öğretmenlik Mesleği Kanunu, öğretmenliğe girişi yeniden düzenledi.[@rg7528] Yeni modelde öğretmen olmak için öğretmenliğe kaynak olan bir lisans programından mezun olmak yeterli değil; Millî Eğitim Akademisi'nin hazırlık eğitimini başarıyla tamamlamak da gerekiyor.[@meb-kanun] Hazırlık eğitiminin usul ve esasları ise MEB'in **Öğretmenlik Mesleğine Hazırlık Eğitimi Yönetmeliği** ile düzenlendi.[@mea-yonetmelik]

## Akademiye kabul

Akademiye kabul, ÖSYM'nin yaptığı Millî Eğitim Bakanlığı Akademi Giriş Sınavı (AGS) sonuçlarına göre yapılır. İlk AGS 13 Temmuz 2025'te uygulandı.[@meb-ags] Sınavın yapısını [AGS nedir?](/blog/ags-nedir) yazımızda anlattık.

Aralık 2025'te öğretmenlik esaslarına eklenen hükümle, hazırlık eğitimine alınacak adaylarda pedagojik formasyonla ilgili şartlar aranmıyor.[@ttkb-esaslar] Bu değişikliğin ayrıntılarını [pedagojik formasyon kalktı mı?](/blog/pedagojik-formasyon-kalkti-mi) yazımızda ele aldık.

## Hazırlık eğitiminin yapısı

MEB'in yayımladığı programa göre hazırlık eğitimi **onar haftalık dört dönemden** oluşur. İlk üç dönem ortak dersleri, dördüncü dönem ise tamamen uygulamayı kapsar. Süre, Akademik Kurul kararıyla belirlenen bazı yükseköğretim programları için üç dönem olarak uygulanabilir.[@mea-program]

İlk hazırlık eğitimi 13 Nisan 2026'da başladı.[@mea-takvim] Açıklanan akademik takvime göre dönemler şöyle planlandı:[@mea-akademik]
...
- **Uygulama dönemini önemseyin:** Dördüncü dönem, lisanstaki öğretmenlik uygulamasının devamı ve derinleşmesi olarak görülebilir. Lisanstaki uygulama deneyiminiz bu dönemde işinize yarar; bu deneyimi [öğretmenlik uygulaması](/blog/ogretmenlik-uygulamasi-nedir) yazımızda ele aldık.
