...
Eğitim fakültelerinde sınıf ve okul öncesi öğretmenliğinden matematik, fen ve dil öğretmenliklerine, rehberlik ve özel eğitimden [Bilgisayar ve Öğretim Teknolojileri Öğretmenliği](/blog/bote-nedir)'ne kadar pek çok program bulunur.
...
7528 sayılı Kanun'a göre öğretmen olacak kişiler, öğretmenliğe kaynak olan en az lisans düzeyindeki bir programdan mezun olan ve Millî Eğitim Akademisi'nin hazırlık eğitiminde başarılı olan adaylar arasından seçilir.[@meb-kanun] Yeni süreç özetle şöyle işler:

1. Öğretmenliğe kaynak olan bir lisans programından mezun olmak,
2. ÖSYM'nin yaptığı **MEB Akademi Giriş Sınavı'na (AGS)** girmek,[@meb-ags]
